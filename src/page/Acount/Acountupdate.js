...
function Acountupdate() {
    ...
    const form = useForm({
        defaultValues: {
            image: 'https://upload.wikimedia.org/wikipedia/commons/0/06/Tr%C3%BAc_Anh_%E2%80%93_M%E1%BA%AFt_bi%E1%BA%BFc_BTS_%282%29.png',
            phoneNumber: '',
            email: '',
            name: '',
            gender: '',
                ...
                <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg mt-16">
                    ...
                    <div className="px-6">
                        <div className="flex flex-wrap justify-center">
                            <h1 className="text-2xl">Update Account</h1>
                            <form onSubmit={form.handleSubmit(handleSubmitForm)}>
                                ...
                                <div className="w-full px-4  mt-10 me-10">
                                    ...
                                    <InputField name="passwordConfirm"
                                        ...
                                        mode="role"
                                        optionData={[
                                            { label: ' admin', value: Number(1) },
                                            { label: 'user', value: Number(0) },
                                            { label: 'center', value: Number(2) }
                                        ]}
                                    />
